...
def group_anagrams(strings): 
    ...
    for string in strings:
        # sorted() transform a string "ate" in a array "[a,t,e]"
        # ''.join() transform a array in a string in order ("aet")
        canonical = ''.join(sorted(string))

        # if the "canonical" already existis, append the new string into the array
        # If not, create a new array in canonical position
